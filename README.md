<p align="center"><a href="https://darkwood.com" target="_blank">
    <img src="https://darkwood.com/logo.svg" alt="Darkwood Logo">
</a></p>
...
- PHP **8.5+** for Flow, Navi, MediaBundle and IaExceptionBundle
- [Composer](https://getcomposer.org/)
- OpenSwoole extension for Flow and Navi CI runtime tests
...
```bash
cd src/Component/Navi   #Flow or MediaBundle, IaExceptionBundle
composer install
```
...
darkwood/
├── src/
│   ├── Component/     # Standalone libraries (Flow, Navi)
...
├── CONTRIBUTING.md
└── .github/           # Shared automation (fabbot, PR template)
```

Per-package CI workflows currently live under each package `.github/workflows/` (centralization planned).
